...
/**
 * @extends ModelResource<MessageFile>
 */
class MessageFileResource extends ModelResource
{
    protected string $model = MessageFile::class;

    protected string $title = 'MessageFiles';
