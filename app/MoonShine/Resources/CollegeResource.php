...
/**
 * @extends ModelResource<College>
 */
class CollegeResource extends ModelResource
{
    protected string $model = College::class;

    protected string $title = 'Colleges';
    ...
    public function indexFields(): array
    {
        return [
            ...
            BelongsTo::make('University', 'university', 'native_name', resource: new UniversityResource()),
        ];
    }
