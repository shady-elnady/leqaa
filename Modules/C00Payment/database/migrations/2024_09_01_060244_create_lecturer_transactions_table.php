...
return new class extends BasePaymentMigration
{
    ...
    {
        Schema::create("{$this->base_dir}_lecturer_transactions", function (Blueprint $table) {
            ...
            $table->foreign('event_id')->references('id')->on("{$this->event_module_dir}_events");
            //
    ...
    {
        Schema::dropIfExists("{$this->base_dir}_lecturer_transactions");
    }
};
