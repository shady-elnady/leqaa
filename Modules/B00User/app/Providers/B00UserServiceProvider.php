...
namespace Modules\B00User\Providers;
...
use Modules\B00User\Repositories\AdminRepository;
use Modules\B00User\Repositories\InterestRepository;
use Modules\B00User\Repositories\LecturerRepository;
use Modules\B00User\Repositories\StudentRepository;

class B00UserServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'B00User';

    protected string $moduleNameLower = 'b00user';
